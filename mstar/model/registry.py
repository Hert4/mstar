...
HF_MODELS: dict[str, dict] = {
    ...
    # Audio encoder shared with Qwen3-Omni, decoder a dense Qwen3. Unlike
    # Whisper the audio enters as tokens, so KV scales with the clip.
    "qwen3_asr": {"model_path_hf": "Qwen/Qwen3-ASR-0.6B"},

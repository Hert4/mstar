...
Cloning, batches, the multipart form and the TTS wrapper's field names each have
their own shape. They are documented with a runnable ``curl`` apiece in
:doc:`omnivoice-speech`.
